...
# e.pack()
#
# button1 = Button(root, text="Start", padx=50, command=Application.start)
# button1.pack()
# button2 = Button(root, text="Exit", padx=50, command=root.quit)
# button2.pack()
#
# root.mainloop()
from tkinter import *
...
ships = {"Cruiser": 4, "Battleship": 3, "Destroyer": 2}
AI = False
